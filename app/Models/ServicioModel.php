...
class ServicioModel extends Model
{
	...
	protected $allowedFields = ['nidservicio', 'tfechaingreso', 'sidusuario', 'sobservacioningreso', 'sidcliente', 'nidtiposervicio', 'nidbanda', 'nidneumatico', 'nidubicacion', 'nidrencauchadora', 'tfechasalida', 'sobservacionsalida', 'nidcondicion', 'bestado'];
...
//   SECCION ====== GET ======
	public function getservicio($nidservicio, $sidusuario, $sidcliente, $nidtiposervicio, $nidbanda, $nidneumatico, $nidubicacion, $nidrencauchadora, $nidcondicion){
		$builder = $this->conexion('tservicio t0');
		$builder->select("t0.nidservicio idservicio, DATE_FORMAT(t0.tfechaingreso,'%d/%m/%Y') fechaingreso, t0.sidusuario idusuario, t0.sobservacioningreso observacioningreso, t0.sidcliente idcliente, t0.nidtiposervicio idtiposervicio, t0.nidbanda idbanda, t0.nidneumatico idneumatico, t0.nidubicacion idubicacion, t0.nidrencauchadora idrencauchadora, DATE_FORMAT(t0.tfechasalida,'%d/%m/%Y') fechasalida, t0.sobservacionsalida observacionsalida, t0.nidcondicion idcondicion, t0.bestado estado");
