    ...
    <!-- Brand Logo -->
    <a href="<?php echo base_url()."/publico";?>" class="brand-link">
      <img src= "<?php echo base_url()?>/uploads/logo/logo-footer-02.png" alt="Gestion de llantas" class="brand-image img-circle elevation-3"
           style="opacity: .8">
