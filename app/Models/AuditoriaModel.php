...
//   SECCION ====== TODOS ======
	public function getAuditorias($total, $pag = 1, $todos = 1, $text = ''){
		...
		$builder->join('treencauchadora t7', 't7.nidreencauchadora = t1.nidreencauchadora');
